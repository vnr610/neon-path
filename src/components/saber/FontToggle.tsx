 ...
 * Fonts are grouped by category with live "Aa" previews.
 */
...
/* Per-theme font-family for the live "Aa" preview */
    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full right-0 mt-2 w-60 rounded-xl border border-border/60 bg-background/95 backdrop-blur-xl shadow-lg z-50 animate-scale-in overflow-hidden">
          ...
          <div className="max-h-80 overflow-y-auto overscroll-contain pb-1.5">
            {GROUPS.map((group) => {
