/**
 * newsletter-subscribe — saves subscriber to DB and sends a welcome email via Resend.
 *
 * Required secrets:
 *   RESEND_API_KEY   — from resend.com
 *   SITE_URL         — your site URL e.g. https://vnr610.dev
      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#0f0f0f;border:1px solid #222;border-radius:8px;overflow:hidden;max-width:520px;width:100%;">
        ...
        <tr><td style="padding:32px 28px;">
          ...
          <p style="margin:0 0 24px;font-size:14px;color:#888;line-height:1.7;">
            You'll get notified when new writeups, projects, and milestones drop on the Realm Codex.
